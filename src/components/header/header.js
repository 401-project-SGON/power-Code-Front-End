...
const Header = (props) => {
    ...
    return (
        <>
            ...
            <div id="navbar">
                <Navbar >
                <Nav.Link ><NavLink to='/'><img src='https://cdn2.iconfinder.com/data/icons/circular-icons-filled/78/Circular_House-512.png' height='40' width='40' /></NavLink></Nav.Link >
                        ...
                        <If condition={props.reducer.user.url}>
                            <Then>
                                <NavDropdown title={props.reducer.user.username} id="basic-nav-dropdown">
                                    ...
                                    <NavDropdown.Divider />
                                    <NavDropdown.Item ><img class="imgp" src={props.reducer.user.url} height='50' width='50' /></NavDropdown.Item>

                                    <Login />

                                </NavDropdown>
                                <img class="imgp" src={props.reducer.user.url} height='45' width='45' />
